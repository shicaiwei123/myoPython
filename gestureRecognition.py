"""
实现了手势识别和语音合成功能，即聋哑人到正常人之间的信息交互过程
"""

import GetData.getData as myoData
from DataAnalysis.myoAnalysis import featureGet, featureGetTwo
from DataAnalysis.myoAnalysis import excelToDict
from DataAnalysis.myoAnalysis import normalized
from DataAnalysis.myoAnalysis import DataCache
...
import time
import os
from SpeechSynthesis.speechSynthesis import xf_speech
import json
